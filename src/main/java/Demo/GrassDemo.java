 ...
 * <p>
 * This demo uses per-instance attributes to position, rotate and animate the
 * grass blades.
 *
 * @author Kai Burjack
 */
public class GrassDemo {
    ...
    private static final int NUM_GRASS_PATCHES = 12300;
    ...
    private void createGrassProgram() throws IOException {
        ...
        int vshader = createShader("res/grass.vs", GL_VERTEX_SHADER, null);
        int fshader = createShader("res/grass.fs", GL_FRAGMENT_SHADER, null);
    ...
    private void createGroundProgram() throws IOException {
        int program = glCreateProgram();
        int vshader = createShader("res/ground.vs", GL_VERTEX_SHADER, null);
        int fshader = createShader("res/ground.fs", GL_FRAGMENT_SHADER, null);
        glAttachShader(program, vshader);
        glAttachShader(program, fshader);
        glLinkProgram(program);
        int linked = glGetProgrami(program, GL_LINK_STATUS);
    ...
    private static int loadTexture(String name) throws IOException {
        ...
        ByteBuffer data = stbi_load_from_memory(ioResourceToByteBuffer(name, 1024), width, height, components, 4);
    ...
    private void createGrassTextures() throws IOException {
        grassTex0 = loadTexture("res/grass.png");
        grassTex1 = loadTexture("res/grass2.png");
        grassTex2 = loadTexture("res/grass_flower.png");
        grassTex3 = loadTexture("res/grass_flower_blue.png");
    }
